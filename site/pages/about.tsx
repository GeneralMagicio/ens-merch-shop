...
export default function About({ products }: InferGetStaticPropsType<typeof getStaticProps>) {
	return (
		<>
			<div className='max-w-3xl px-4 my-44 mx-auto'>
				...
				<p className='mt-14 text-2xl font-bold leading-8'>
					...
					which is a distributed, open, and extensible naming system based on the Ethereum
					blockchain.
				</p>
				...
				<p className='text-xl font-medium leading-7'>
					...
					is a group of Web3 professionals with deep roots in the Ethereum ecosystem devoted to
					supporting commons-based organizations and public good projects. Our core business is
					providing solution services for impact DAOs. We sell high-quality merch for ENS
					domains owners.
				</p>
			</div>
