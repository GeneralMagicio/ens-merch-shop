const RatingHeartFilled = ({ ...props }) => {
  return (
    <svg
      ...
      {...props}
    >
      <g fill="#3889FF" clip-path="url(#a)">
        <path
          d="M11.625 1.5C8.27 1.5 8 4.465 8 4.465S7.731 1.5 4.375 1.5C2.227 1.5.539 3.407 1.113 6.302c.44 2.216 4.24 6.123 6 7.834a1.263 1.263 0 0 0 1.774 0c1.76-1.71 5.56-5.618 6-7.834.574-2.895-1.114-4.802-3.262-4.802Z"
          opacity=".35"
        />
        <path
          fill-rule="evenodd"
...
export default RatingHeartFilled
