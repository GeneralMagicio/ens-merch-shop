...
const Logo = ({
    ...
    if (size === 'small') {
      return (
        ...
        >
          <path
            fill="#F2F2F2"
            d="M4.436 8.966a4.573 4.573 0 0 1 1.49-1.643L16.385 0 5.668 17.768s-.937-1.587-1.302-2.39a7.616 7.616 0 0 1 .07-6.412ZM.12 21.223c.118 1.699.597 3.353 1.405 4.852a11.947 11.947 0 0 0 3.278 3.837L16.372 38S9.132 27.541 3.027 17.134A10.53 10.53 0 0 1 1.8 13.585a5.695 5.695 0 0 1 0-1.704c-.159.296-.468.902-.468.902a13.802 13.802 0 0 0-1.25 4.013 24.603 24.603 0 0 0 .037 4.427Zm29.499 1.408c-.375-.803-1.302-2.39-1.302-2.39L17.617 38l10.46-7.318a4.573 4.573 0 0 0 1.49-1.643 7.62 7.62 0 0 0 .07-6.413l-.02.005Zm4.246-5.85a11.98 11.98 0 0 0-1.404-4.85 11.949 11.949 0 0 0-3.278-3.838L17.631 0s7.234 10.459 13.345 20.866c.616 1.1 1.03 2.302 1.222 3.549.085.565.085 1.14 0 1.704.159-.296.468-.901.468-.901.619-1.266 1.04-2.62 1.25-4.014a24.596 24.596 0 0 0-.033-4.427l-.019.005Z"
          />
        </svg>
      )
    } else {
  ...
  return (
    ...
    >
      ...
      <path
        fill="url(#a)"
        d="M5.593 11.294a5.761 5.761 0 0 1 1.877-2.07L20.656 0 7.145 22.38s-1.18-1.998-1.641-3.01a9.587 9.587 0 0 1 .089-8.076ZM.15 26.732a15.08 15.08 0 0 0 5.903 10.945l14.585 10.188S11.513 34.69 3.816 21.582a13.255 13.255 0 0 1-1.547-4.47 7.167 7.167 0 0 1 0-2.146c-.2.372-.59 1.135-.59 1.135a17.375 17.375 0 0 0-1.576 5.055 30.965 30.965 0 0 0 .047 5.576Zm37.186 1.774c-.472-1.011-1.641-3.01-1.641-3.01L22.208 47.865l13.186-9.219a5.761 5.761 0 0 0 1.877-2.069 9.59 9.59 0 0 0 .089-8.077l-.024.006Zm5.353-7.368a15.08 15.08 0 0 0-5.902-10.944L22.226 0s9.119 13.174 16.822 26.283a13.258 13.258 0 0 1 1.54 4.47 7.17 7.17 0 0 1 0 2.146c.2-.372.59-1.135.59-1.135a17.37 17.37 0 0 0 1.576-5.056 30.96 30.96 0 0 0-.04-5.575l-.025.005Z"
      />
      <path
        fill="url(#b)"
        d="M66.875 33.951v-3.843h-8.997V25.26h8.144v-3.636h-8.144v-4.789h8.997v-3.843H53.82v20.96h13.055Z"
      />
      <path
        fill="url(#c)"
        d="M88.635 33.951V12.992h-4.058v13.865l-8.673-13.864h-5.057V33.95h4.057V19.082l9.468 14.87h4.263Z"
      />
      <path
        fill="url(#d)"
        d="M107.584 17.988c-.471-2.365-2.411-5.439-7.468-5.439-3.94 0-7.262 2.838-7.262 6.563 0 3.163 2.146 5.32 5.468 6l2.911.592c1.617.325 2.529 1.27 2.529 2.483 0 1.478-1.206 2.572-3.382 2.572-2.94 0-4.38-1.863-4.557-3.932l-3.763 1.005c.323 2.986 2.763 6.563 8.291 6.563 4.851 0 7.527-3.252 7.527-6.474 0-2.956-2.029-5.44-5.822-6.178l-2.91-.562c-1.53-.296-2.264-1.212-2.264-2.365 0-1.39 1.293-2.66 3.263-2.66 2.646 0 3.587 1.803 3.793 2.956l3.646-1.124Z"
      />
      <defs>
        <linearGradient
          id="a"
        ...
        >
          ...
          <stop offset=".379" stop-color="#7298F8" />
