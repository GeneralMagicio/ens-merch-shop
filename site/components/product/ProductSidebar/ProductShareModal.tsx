  ...
  return (
    <div className="text-center md:p-6">
      ...
      <div className="flex items-center justify-center gap-4">
        ...
        <LinkedinShareButton title={shareTitle} url={url}>
          <Linkedin />
        </LinkedinShareButton>
        <FacebookShareButton
      ...
      <p className="mt-4 mb-4 text-black text-md font-bold">Or copy the link</p>
      <div
        onClick={() => !isCopied && handleCopy()}
        className="flex flex-col md:flex-row py-2 justify-center items-center border border-dashed border-gray-400 rounded-lg mt-5 mx-auto shadow-lg cursor-pointer"
      >
        ...
        <button className="text-sm uppercase font-bold m-auto w-28 flex-shrink-0 flex-grow-0 text-pink-light">
